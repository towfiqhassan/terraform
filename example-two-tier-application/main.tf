...
#Below are region/az specific variables
# A. grab the ami from aws console
# B. create KeyPair upfront in the chosen region

locals {
  ami_name = "ami-089a545a9ed9893b6"
  key_pair_name = "global-dev-th-keyPair-region-ohio"
}
...
resource "aws_instance" "web1" {
  ...
  user_data = <<-EOF
        ...
        echo "<html><body><h1>Hi there from us-east-2a</h1></body></html>" > /var/www/html/index.html
        EOF
...
resource "aws_instance" "web2" {
  ...
  user_data = <<-EOF
        ...
        systemctl start httpd
        systemctl enable httpd
        echo "<html><body><h1>Hi there from us-east-2b</h1></body></html>" > /var/www/html/index.html
        EOF
